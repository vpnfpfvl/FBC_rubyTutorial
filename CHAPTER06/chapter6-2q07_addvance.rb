word ="Friends, delegates and fellow Americans: I humbly and gratefully accept your nomination for the presidency of the United States.
...
Iraq is in chaos. Iran is on the path to nuclear weapons. Syria is engulfed in a civil war and a refugee crisis now threatens the West. After fifteen years of wars in the Middle East, after trillions of dollars spent and thousands of lives lost, the situation is worse than it has ever been before.
...
As your President, I will do everything in my power to protect our LGBTQ citizens from the violence and oppression of a hateful foreign ideology. Believe me.　I have to say as a republican it is so nice to hear your cheering about what I just said. Thank you. To protect us from terrorism, we need to focus on three things.

We must have the best, absolutely the best gathering of intelligence anywhere in the world. The best. We must abandon the failed policy of nation-building and regime change that Hillary Clinton pushed in Iraq, in Libya, in Egypt and in Syria.
...
But where was the sanctuary for Kate Steinle? Where was the Sanctuary for the children of Mary Ann, and Sabine, and Jamiel? Where was the Sanctuary for all the other Americans who have been so brutally murdered, and who have suffered so so horribly?
...
charsDiv.each do |char|
  if (charCount.member?(:"#{char}") == false) then
    puts "新しい文字" + "#{char}" + "が追加されました"
    charCount = charCount.merge({ :"#{char}"=> 1})
    next
  else 
    puts "#{char}" + "はすでに登録されています。"
